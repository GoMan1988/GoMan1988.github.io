...
window.addEventListener("load",function(){function e(){o.style.display="block"}function t(){o.style.display="none"}function n(){u.style.display="block"}function i(){u.style.display="none"}var a=document.querySelector(".menu__link.menu__link--submenu"),o=document.querySelector(".submenu"),s=document.querySelector(".search__button"),u=document.querySelector(".search__conteiner-input");a.addEventListener("mouseover",e,!0),a.addEventListener("mouseout",t,!0),s.addEventListener("mouseover",n,!0),s.addEventListener("mouseout",i,!0);var r=$("#my-menu").mmenu({extensions:["theme-black","effect-menu-slide","pagedim-black"],navbar:{title:'<img src="img/logo.png" alt="Логотип">'},offCanvas:{position:"right"}}),l=$("#my-icon"),m=r.data("mmenu");l.on("click",function(){m.open()}),m.bind("open:finish",function(){setTimeout(function(){l.addClass("is-active")},100)}),m.bind("close:finish",function(){setTimeout(function(){l.removeClass("is-active")},100)})}),$(document).ready(function(){$(".vestibulum").owlCarousel({center:!0,merge:!0,loop:!0,margin:10,nav:!0,smartSpeed:1e3,responsive:{0:{items:1},600:{items:1},1e3:{items:1}},dots:!0,autoplay:!0,autoplayTimeout:5e3,autoHeight:!0,navText:['<i class="fa fa-angle-double-left" aria-hidden="true"></i>','<i class="fa fa-angle-double-right" aria-hidden="true"></i>']})}),$(document).ready(function(){$(".your-images").owlCarousel({center:!0,merge:!0,loop:!0,margin:10,nav:!1,smartSpeed:1e3,items:3,responsive:{0:{items:1},992:{items:3}},dots:!1,autoplay:!0,autoplayTimeout:5e3,autoHeight:!0,navText:['<i class="fa fa-angle-double-left" aria-hidden="true"></i>','<i class="fa fa-angle-double-right" aria-hidden="true"></i>']})}),$(document).ready(function(){$(".happy-clients").owlCarousel({merge:!0,loop:!0,margin:30,nav:!0,smartSpeed:1e3,responsive:{1:{items:1,center:!0},320:{items:1.7,center:!0},360:{items:2,center:!0},480:{items:2.5,center:!0},768:{items:4},992:{items:5},1200:{items:6}},dots:!1,autoplayTimeout:5e3,autoHeight:!0,navText:['<i class="fa fa-chevron-left" aria-hidden="true"></i>','<i class="fa fa-chevron-right" aria-hidden="true"></i>']})});